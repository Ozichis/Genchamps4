...
questions = ["Who died for our sins?",
             "Where did Jonah go to when God told Him to go to Ninevah?",
             "Did God Say that hardwork is good?",
             "By What means did Jonah go to Tarshish?",
             "Who was Jesus' Father?",
             "Who was Jesus' Mother",
             "Philippians 2:3 says '.... Rather in _______ value others above yourselves'",
...
first_option = ["Joseph", "Jerusalem",
                "Yes", "Airplane",
                "Joseph", "Martha",
                "Strength", "Elephant", "11:23PM", "KKR",
                "Earth", "8",
                "100 years", "Google", "Monty Ritz"]

second_option = ["Peter", "Israel",
                 "No", "Road",
                 "Isaac", "Esther",
                 "Humility", "Lion", "11.11PM", "CSK",
                 "Uranus", "5",
                 "50 years",
                 "Microsoft", "Danis Lio"]

third_option = ["Jacob", "Tarshish",
                "", "Train",
                "Jacob", "Mary",
                "Victory", "Tiger", "7:23PM", "MI",
                "Mars", "7",
                "500 years",
                "Amazon", "Bill Gates"]

fourth_option = ["Jesus", "Judea",
                 "", "Ship",
                 "David", "Sarah",
                 "Sorrow", "Cow", "9.11PM", "RCB",
                 "Jupiter",
                 "6",
                 "1000 years", "Apple",
                 "Jeff Bezos"]

correct_answers = ["Jesus", "Tarshish", "Yes", "Ship", "Joseph", "Mary",
                   "Victory", "Lion", "7:23PM", "MI", "Jupiter", "7", "1000 years", "Apple",
                   "Bill Gates"]
    ...
    for i in range(15):
        if value == correct_answers[i]:
            if value == third_option[14]:
                ...
                root2.title('You won 1 million Coins')
                centerimg = PhotoImage(file='mutiplat.png')
        ...
        if value not in correct_answers:
            ...
            root1.title('You won 0 Points')
            img = PhotoImage(file='mutiplat.png')
...
centreImage = PhotoImage(file='mutiplat.png')
